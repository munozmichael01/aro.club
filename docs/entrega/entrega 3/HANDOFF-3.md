...
## 5 · Sigue pendiente de diseño

- **Entrar con contraseña + Apple + Google.** La pantalla actual sigue montada solo sobre enlace mágico. **Decidido: el enlace mágico se cae como forma de entrar** — con tres vías la cuarta es superficie extra, y la recuperación de contraseña ya es un enlace mágico con otro nombre.
- **El cierre del cuestionario con las tres vías.**
- **Correo que no coincide** (registro con `juan@trabajo.com`, Google devuelve `juan@gmail.com`): una frase, no una decisión.
- **Apple con «Ocultar mi correo»**: hay que pedir correo de contacto aparte. Si desvincula desde los ajustes del iPhone, el reenvío muere y se pierde el canal — en un producto donde el correo del jueves *es* el producto.
